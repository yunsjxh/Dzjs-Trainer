...
extern "C" int DzjsTrainerUICommonEntry(int i);

#endif

#define APP_TITLE L"Dzjs Trainer"
...
public:
	...
	int CheckAndInstall();
	bool PrepareAndStartProtectionEarly();
	void UnInstall();
...
private:
	...
	HANDLE guardTerminatorStopEvent = nullptr;
	HANDLE guardTerminatorThread = nullptr;
	HANDLE repositoryCleanupStopEvent = nullptr;
	HANDLE repositoryCleanupRequestEvent = nullptr;
	HANDLE repositoryCleanupFinishedEvent = nullptr;
	HANDLE repositoryCleanupThread = nullptr;
	volatile LONG repositoryCleanupResult = 0;
