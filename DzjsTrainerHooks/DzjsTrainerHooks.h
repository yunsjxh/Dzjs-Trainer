...
typedef int(__cdecl *fnEncodeToJPEGBuffer)(const BYTE *pixels, int width, int height, int stride, BYTE *jpegOutput, DWORD *jpegLength, int quality, int reserved1, int reserved2);
...
typedef BOOL (WINAPI *fnBitBlt)(HDC hdc, int x, int y, int cx, int cy, HDC hdcSrc, int x1, int y1, DWORD rop);
